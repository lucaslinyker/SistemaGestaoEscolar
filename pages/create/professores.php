...
<body>
  ...
  <main>
    <div class="container">
      <h2 class="mt-4 text-center">Cadastrar Professor</h2>
      <form action="../edit-create.php?id_old=<?php echo $atributos['Id']; ?>" method="post" autocomplete="off">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" maxlength="100" name="especialidade" id="especialidade" value="<?php echo $atributos['Especialidade']; ?>" required>
        </div>
        <div class="mb-3">
          <label for="contato" class="form-label">Contato:</label>
          <input type="email" pattern=".+@etec\.sp\.gov\.br" maxlength="100" class="form-control" name="contato" id="contato" value="<?php echo $atributos['Contato']; ?>" required>
